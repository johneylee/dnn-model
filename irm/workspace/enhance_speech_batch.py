"""
example
python enhance_speech_batch.py job/model_irm irm
"""
import os
import sys
import numpy as np
...
def main():
    ...
    print('scanning --')
    for (path, dir, files) in os.walk("../data/speech/test/noisy"):
        print(files)
        for data in files:
