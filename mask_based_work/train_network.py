...
hps = senet.hparams(mode=cfg.mode, job_dir=cfg.job_dir,		# from config.py
					num_context_window=cfg.num_context_window, dnn_struct
					=get_structure_params(cfg.input_dim,
													cfg.output_dim,
													cfg.layer_size,
													cfg.num_layer,
